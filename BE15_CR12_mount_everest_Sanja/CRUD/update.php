        ...
        <fieldset>
            ...
            <form action="actions/a_update.php"  method="post" enctype="multipart/form-data">
                <table class="table">
                    <tr>
                        <th>Name</th>
                        <td><input class="form-control" type="text"  name="name" placeholder ="Destination Name" value="<?php echo $name ?>"  /></td>
                    </tr>
                    <tr>
                        <th>Price</th>
                    ...
                    <tr>
                        <th>Description</th>
                        <td><input class="form-control" type="text"  name="description" placeholder ="Description Name" value="<?php echo $description ?>"  /></td>
                    </tr>
                    <tr>
                        <th>Picture</th>
